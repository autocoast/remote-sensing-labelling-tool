<!--
  ...
  Copyright (C) 2024 David Pogorzelski
        ...
        <div
            ...
            <div class="card-body">
                <ul class="steps">
                    ...
                    <li class="step text-sm">Configure Satellite</li>
                    <li class="step text-sm">Define Classes</li>
                    <li class="step text-sm">Label</li>
                </ul>
                <div class="m-2"></div>
                <!-- Header -->
                <h1 class="text-2xl font-bold text-center text-primary">Upload Files </h1>
                ...
                <p class="mb-4 text-center text-slate-500">Upload the data you wish to label, along with any optional
                    images you may
                    want to use during labeling (e.g., elevation maps). GeoTIFFs are preferred, but other formats such
                    as PNG, JPEG, and BMP are also supported. <NuxtLink class="text-primary dark:text-coolgreen"
                        to='/learn-more'>
                        Learn
                        more</NuxtLink>
                </p>
                ...
                <div class="form-control w-full mb-4">
                    <div class="border-2 border-dashed dark:border-coolgreen rounded-lg p-6 bg-base-200 flex flex-col items-center justify-center"
                        ...
                        <label for="file-upload"
                            class="dark:text-coolgreen dark:bg-black dark:border-0 dark:hover:bg-slate-950 btn btn-primary hover:bg-slate-900">
                            Upload Folder
                        </label>
                    </div>
                </div>
                ...
                <h2 class="text-lg font-semibold">Uploaded Files (TIF, TIFF, BMP, PNG, JPG, JPEG)</h2>
